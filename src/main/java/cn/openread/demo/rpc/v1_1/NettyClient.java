package cn.openread.demo.rpc.v1_1;

import cn.openread.demo.rpc.v1.RpcDecode;
import cn.openread.demo.rpc.v1.RpcEncode;
import cn.openread.demo.rpc.v1.Serializer;
        ...
        bootstrap.group(group).channel(NioSocketChannel.class).handler(new ChannelInitializer<SocketChannel>() {
            ...
            public void initChannel(SocketChannel channel) throws Exception {
                channel.pipeline().addLast(new RpcEncode(RpcRequest.class, serializer))
                        .addLast(new RpcDecode(RpcResponse.class, serializer)).addLast(new NettyClientHandler());
            }
